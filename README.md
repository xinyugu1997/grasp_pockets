...
[`grasp_cluster_pockets_with_residues.ipynb`](https://colab.research.google.com/github/xinyugu1997/grasp_pockets/blob/main/grasp_cluster_pockets_with_residues.ipynb) groups high-scoring protein atoms into predicted pockets using the GRASP score stored in each PDB atom's B-factor column. It reports the residue IDs belonging to each retained pocket.
